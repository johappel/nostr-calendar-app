export const Config = {
  ...
  wordpress: {
    // WordPress site URL (can be overridden by SSO session)
    siteUrl: 'https://test1.rpi-virtuell.de',
    // Use WordPress auth plugin if available
    enableSSO: true,
    // Fallback to Nostr auth if WordPress not available
